...
public class CreateListing extends JPanel {
	 ...
	 * @throws SQLException 
	 */
	public CreateListing() throws SQLException {
		...
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				String sql = "INSERT INTO `VehicleInfo`(`listID`, `year`, `make`, `model`, `mileage`, `title`, `cost`, `engineType`, `transmission`, `powertrain`, `fuelType`, `vin`, `formFactor`, `color`, `dealID`)" +" VALUES ("+ 1 +", "+year.getText()+", '"+make.getText()+"', '"+model.getText()+"', "+mileage.getText()+", '"+titleList.getSelectedValue()+"', "+price.getText()+", '"+engineType.getText()+"', '"+transmissionList.getSelectedValue()+"', '"+trainList.getSelectedValue()+"', '"+fuelList.getSelectedValue()+"', '"+vin.getText()+"', '"+formFactorList.getSelectedValue()+"', '"+color.getText()+"', 'D001454657');";
				try {
