	...
	public Edit(final String login, final int listID) throws SQLException {
		...
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				String sql = "UPDATE `VehicleInfo` SET listID = listID, year = "+year.getText()+", make = '"+make.getText()+"', model = '"+model.getText()+"', mileage = "+mileage.getText()+", title = '"+titleList.getSelectedValue()+"', cost = "+price.getText()+", engineType = '"+engineType.getText()+"', transmission = '"+transmissionList.getSelectedValue()+"', powertrain = '"+trainList.getSelectedValue()+"', fuelType = '"+fuelList.getSelectedValue()+"', vin = '"+vin.getText()+"', formFactor = '"+formFactorList.getSelectedValue()+"', color = '"+color.getText()+"', dealID = '"+login+"' WHERE listID = "+listID+";";
				try {
